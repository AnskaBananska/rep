...
heat5 <- pheatmap(ungappy_wide_matrix_t_means_renamed ,scale="row",show_rownames=FALSE, annotation_col = anndf_cols5, annotation_colors = my_colour5, height = 20)
heat5


# ggsave(path = "C:/Users/1aria/Desktop/rep/Output/Plots",   filename = "Heatmap5.png",heat5,height=20,width=17,units="cm",dpi=200)
```
