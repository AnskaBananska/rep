...
# ClusterProfiler - works!!

Follow: <https://www.youtube.com/watch?v=JPwdqdo_tRg&t=43s>
### Load packages
```{r}
...
### Run GO GSEA
```{r}
GSEA_GO_BP_poslog2 <- gseGO(geneList     = geneList,
              OrgDb        = org.Hs.eg.db,
              ont          = "BP",
              minGSSize    = 10,
              maxGSSize    = 500,
...
GSEA_GO_MF_poslog2 <- gseGO(geneList     = geneList,
              OrgDb        = org.Hs.eg.db,
              ont          = "MF",
              minGSSize    = 10,
              maxGSSize    = 500,
...
GSEA_GO_CC_poslog2 <- gseGO(geneList     = geneList,
              OrgDb        = org.Hs.eg.db,
              ont          = "CC",
              minGSSize    = 10,
              maxGSSize    = 500,
...
GSEA_GO_BP_poslog2_df <- as.data.frame(GSEA_GO_BP_poslog2)
GSEA_GO_MF_poslog2_df <- as.data.frame(GSEA_GO_MF_poslog2)
GSEA_GO_CC_poslog2_df <- as.data.frame(GSEA_GO_CC_poslog2)
...
cnetplot(kegg_symbols, categorySize="pvalue", foldChange=geneList)   #works
heatplot(kegg_symbols, foldChange=geneList, showCategory=5)
