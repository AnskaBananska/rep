...
### Attach means to original raw df

```{r}
# Check that all all NAs are missing from all trhee replicates
sum(is.na(wide_matrix_t$NR_9_SCR_R2_Set2_tmt16plex_128C))
sum(is.na(wide_matrix_t$NR_9_SCR_R1_Set2_tmt16plex_127C))
sum(is.na(wide_matrix_t$NR_9_SCR_R3_Set2_tmt16plex_129C))

sum(is.na(wide_matrix_t$R_2_SCR_R1_Set1_tmt16plex_131N))
sum(is.na(wide_matrix_t$R_2_SCR_R2_Set1_tmt16plex_132N))
sum(is.na(wide_matrix_t$R_2_SCR_R3_Set1_tmt16plex_133N))
