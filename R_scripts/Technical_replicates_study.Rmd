...
# Rename 'mean' column
wide_matrix_t_mean9_clean  <- wide_matrix_t_mean9_clean %>% rename('R_9_SCR_Set1_tmt16plex_mean' = 'mean')

wide_matrix_t_mean9_clean <- wide_matrix_t_mean9_clean %>% column_to_rownames(., var = 'Gene')
```

```{r}
# Save as a new df to work it from now on

save(wide_matrix_t_mean9_clean, file='wide_matrix_t_means.Rda')
```
