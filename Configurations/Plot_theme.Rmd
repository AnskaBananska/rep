...
colfunc <- colorRampPalette(c("royalblue4", "orange", 'green'))
colfunc(10)
...
repl2_barplot
  ...
  + facet_wrap(~ Sample_nr, scales ="free_y") # make one panel per Sample nr, allows y axis to change automatically, but x set
